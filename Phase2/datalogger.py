...
class Logger:
    ...
    def __init__(self, log_dir):
        ...
        self.log_file_path = os.path.join(self.log_dir, "logs.txt")
        self.log_file = open(self.log_file_path, "w")
        self.log_file.write(
            "Logs Date-Time: " + time.strftime("%d-%m-%Y %H:%M:%S") + "\n\n"
        )
    ...
    def log(self, tag, **kwargs):
        ...
        if tag == "args":
            ...
            self.log_file.write(
                f'Epoch: {kwargs["epoch"]} \t Iteration: {kwargs["iter"]} \t {kwargs["msg"]}\n'
            )
            self.log_file.write(
                "#########################################################\n"
            )
            ...
            self.log_file.write(
                f'Epoch: {kwargs["epoch"]} \t Iteration: {kwargs["iter"]} \t Train Loss: {kwargs["loss"]} \t PSNR: {kwargs["psnr"]} \t Avg Time: {kwargs["time"]} secs\n'
            )

        elif tag == "val":
            self.log_file.write(
                f'Epoch: {kwargs["epoch"]} \t Iteration: {kwargs["iter"]} \t Val Loss: {kwargs["loss"]} \t PSNR: {kwargs["psnr"]} \t Avg Time: {kwargs["time"]} secs\n'
            )
